...
public class MovimentacaoPlayerFase4 : MonoBehaviour
{
	...
	public void setAtacando (bool statusAtacando)
	{
		this.atacando = statusAtacando;
	}
	...
	{	
		pararDash ();
		if (atacando == true &&
		    (other.gameObject.tag == "Minion" || other.gameObject.tag == "Inimigo")) {
