...
public class ManagerAla : MonoBehaviour {
	...
	public void carregarVortex(int idAlavanca){
		...
		if (idAlavanca == 1) {
			if (objetosVortex [0] == null && objetosVortex [1] == null && objetosVortex[2] == null && objetosVortex[3] == null) {
				//inicializa vortex 0
				inicializaVortex(objetosVortex, vortexPrefab, 0, new Vector3 (260.0f, -81.0f, 21.0f), texturas [colorVortex], cores [colorVortex]);
				//inicializa vortex 1
				inicializaVortex(objetosVortex, vortexPrefab, 1, new Vector3 (-310.0f, 114.0f, 21.0f), texturas [colorVortex], cores [colorVortex]);
				//inicializa vortex que desaparece aleatoriamente (2 e 3)
				colorVortex = Random.Range (0, 3); //azul, verde e roxo
				inicializaVortex(objetosVortex, vortexPrefab, 2, new Vector3 (-80.0f, 114.0f, 21.0f), texturas[colorVortex], cores[colorVortex]);
				inicializaVortex(objetosVortex, vortexPrefab, 3, new Vector3 (20.0f, 114.0f, 21.0f), texturas [colorVortex], cores [colorVortex]);
 			}
		}
		if (idAlavanca == 2) {
			if (objetosVortex [4] == null && objetosVortex [5] == null) {
				//inicializa vortex 4
				inicializaVortex(objetosVortex, vortexPrefab, 4, new Vector3 (260.0f, 114.0f, 21.0f), texturas [colorVortex], cores [colorVortex]);
				//inicializa vortex 5
				inicializaVortex(objetosVortex, vortexPrefab, 5, new Vector3 (-260.0f, 315.0f, 21.0f), texturas [colorVortex], cores [colorVortex]);
			}	
		...
		if (idAlavanca == 3) {
			if (objetosVortex [6] == null) {
				//inicializa vortex 6
				inicializaVortex(objetosVortex, vortexPrefab, 6, new Vector3 (260.0f, 315.0f, 21.0f), texturas [colorVortex], cores [colorVortex]);
			}
		}
	}
	...
	public void inicializaVortex(GameObject[] arrayVortex, GameObject vortexPrefab, int id, Vector3 posicao, Texture textura, string cor){
